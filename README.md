...
lambda infrastructure décrit par le code un aspect de l'infrastructure à provisionner pour __PROJECT.
...
- [AWS](https://aws.amazon.com/) est la plateforme de services Cloud proposée par Amazon.
    - Utilisateur : `__PROJECT.lambda.infrastructure`
    - Groupe : `lambda.deployer`
- [Terraform Cloud](https://app.terraform.io/) est la plateforme proposée par HashiCorp pour administrer les modifications d'infrastructure
    ...
    - Workspaces : `lambda`
        - [lambda](https://app.terraform.io/app/__ORGANIZATION/workspaces/lambda)
    - Variables
